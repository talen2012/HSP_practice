 ...
 * 15. 实现了选择继续游戏还是开始新游戏
 * 16. 添加了音乐
 * 17. 将所有的增强for，修改为fori, 避免ConcurrentModificationException异常
 */
public class HspTankGame07 extends JFrame {
    ...
    public static void main(String[] args) {
        HspTankGame07 hspTankGame07 = new HspTankGame07();
    }
    ...
    HspTankGame07() {
        ...
        // 每次键盘输入，窗口就会失去焦点，游戏界面就无法监听键盘了
        // 请求焦点
        SwingUtilities.invokeLater(() -> {
            try {
                Thread.sleep(200); // 确保窗口已经显示
        ...
        this.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                System.out.println("窗口失去焦点，重新请求焦点");
